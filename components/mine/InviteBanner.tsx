  ...
  return (
    <>
      <button
        ...
        className="relative flex h-[88px] w-full shrink-0 items-center justify-center overflow-hidden rounded-[12px] border border-white text-center shadow-[0_5px_10px_rgba(51,51,51,0.08)] transition-opacity active:opacity-90"
      >
        ...
        <div className="relative z-10 flex max-w-[58%] flex-col items-center px-2 text-center">
          <h2 className="-skew-x-[10deg] flex items-center justify-center gap-1 font-noto-sc-black text-[28px] font-black leading-normal text-black">
            <span>{t("mine.invitePart1")}</span>
            <span className="text-[#f82a2a]">{t("mine.invitePart2")}</span>
          </h2>
          <p className="mt-1 w-full truncate text-[10px] leading-normal tracking-[0.5px] text-[#8b8b8b]">
