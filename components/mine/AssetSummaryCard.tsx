  ...
  return (
    <section className="relative h-[258px] w-full shrink-0">
      ...
      <div className="absolute left-[28.5px] top-[120px] z-10 flex items-center gap-4">
        ...
        <StatColumn label="总释放(X)" value="999,125,682.55" trailingSpace />
      </div>
...
function ActionButton({
  ...
  return (
    <button
      type="button"
      className={`relative flex h-[66px] w-[98px] shrink-0 flex-col items-center justify-center rounded-[12px] border border-white p-2.5 ${
        isPrimary
