...
export const teamAssets = {
  ...
  statIconGlow: "/assets/team/stat-icon-glow.svg",
  statDivider: "/assets/team/stat-divider.svg",
  ...
  subCardIconGlow: "/assets/team/sub-card-icon-glow.svg",
  perfIconToday: "/assets/team/perf-icon-today.png",
  perfIconTeam: "/assets/team/perf-icon-team.png",
  memberIconGlow: "/assets/team/member-icon-glow.svg",
