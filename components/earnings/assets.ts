/** 收益页静态资源（public/assets/earnings） */
export const earningsAssets = {
  txIcon: "/assets/earnings/tx-icon.png",
  txDivider: "/assets/earnings/tx-divider.svg",
  summaryPattern: "/assets/earnings/summary-pattern-v2.png",
  summaryDecoMask: "/assets/earnings/summary-deco-mask-v2.svg",
